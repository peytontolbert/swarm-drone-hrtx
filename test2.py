...
class TestCustomDroneEnv(unittest.TestCase):
    ...
    def test_observation_space(self):
        ...
        self.assertEqual(
            observation_space.shape, (3, 10), "Incorrect observation space shape."
        )
        self.assertTrue(
    ...
    def test_reset_state(self):
        ...
        self.assertEqual(
            observations.shape, (3, 10), "Reset observation shape is incorrect."
        )
    ...
    def test_drone_dynamics(self):
        ...
        self.assertFalse(
            np.array_equal(initial_observation[:, :3], observations[:, :3]),
