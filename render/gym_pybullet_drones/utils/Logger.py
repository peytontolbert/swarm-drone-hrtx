        ...
        for i in range(self.NUM_DRONES):
            ...
            with open(csv_dir + "/rr" + str(i) + ".csv", "wb") as out_file:
                rdot = np.hstack(
                    [
                        0,
                        (self.states[i, 6, 1:] - self.states[i, 6, 0:-1])
            ...
            with open(csv_dir + "/pr" + str(i) + ".csv", "wb") as out_file:
                pdot = np.hstack(
                    [
                        0,
                        (self.states[i, 7, 1:] - self.states[i, 7, 0:-1])
                        * self.LOGGING_FREQ_HZ,
                    ]
                )
            ...
            with open(csv_dir + "/yar" + str(i) + ".csv", "wb") as out_file:
                ydot = np.hstack(
                    [
                        0,
                        (self.states[i, 8, 1:] - self.states[i, 8, 0:-1])
                        * self.LOGGING_FREQ_HZ,
                    ]
                )
            ...
            with open(csv_dir + "/pwm0-" + str(i) + ".csv", "wb") as out_file:
                np.savetxt(
                    out_file,
                    np.transpose(
                        np.vstack([t, (self.states[i, 12, :] - 4070.3) / 0.2685])
                    ),
                    delimiter=",",
                )
            with open(csv_dir + "/pwm1-" + str(i) + ".csv", "wb") as out_file:
                np.savetxt(
                    out_file,
                    np.transpose(
                        np.vstack([t, (self.states[i, 13, :] - 4070.3) / 0.2685])
                    ),
                    delimiter=",",
                )
            with open(csv_dir + "/pwm2-" + str(i) + ".csv", "wb") as out_file:
                np.savetxt(
                    out_file,
                    np.transpose(
                        np.vstack([t, (self.states[i, 14, :] - 4070.3) / 0.2685])
                    ),
                    delimiter=",",
                )
            with open(csv_dir + "/pwm3-" + str(i) + ".csv", "wb") as out_file:
                np.savetxt(
                    out_file,
                    np.transpose(
                        np.vstack([t, (self.states[i, 15, :] - 4070.3) / 0.2685])
                    ),
                    delimiter=",",
                )
