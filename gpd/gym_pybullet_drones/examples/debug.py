...
if __name__ == "__main__":
    ...
    for i in range(DURATION_SEC * 240):
        X_AX_1 = p.addUserDebugLine(
            lineFromXYZ=[0, 0, 0],
            lineToXYZ=[0.1, 0, 0],
            lineColorRGB=[1, 0, 0],
            parentObjectUniqueId=ROBOT_1,
            parentLinkIndex=-1,
            replaceItemUniqueId=X_AX_1,
            physicsClientId=PYB_CLIENT,
        )
        Y_AX_1 = p.addUserDebugLine(
            lineFromXYZ=[0, 0, 0],
            lineToXYZ=[0, 0.1, 0],
            lineColorRGB=[0, 1, 0],
            parentObjectUniqueId=ROBOT_1,
            parentLinkIndex=-1,
            replaceItemUniqueId=Y_AX_1,
            physicsClientId=PYB_CLIENT,
        )
        Z_AX_1 = p.addUserDebugLine(
            lineFromXYZ=[0, 0, 0],
            lineToXYZ=[0, 0, 0.1],
            lineColorRGB=[0, 0, 1],
            parentObjectUniqueId=ROBOT_1,
            parentLinkIndex=-1,
            replaceItemUniqueId=Z_AX_1,
            physicsClientId=PYB_CLIENT,
        )

        X_AX_2 = p.addUserDebugLine(
            lineFromXYZ=[0, 0, 0],
            lineToXYZ=[0.1, 0, 0],
            lineColorRGB=[1, 0, 0],
            parentObjectUniqueId=ROBOT_2,
            parentLinkIndex=-1,
            replaceItemUniqueId=X_AX_2,
            physicsClientId=PYB_CLIENT,
        )
        Y_AX_2 = p.addUserDebugLine(
            lineFromXYZ=[0, 0, 0],
            lineToXYZ=[0, 0.1, 0],
            lineColorRGB=[0, 1, 0],
            parentObjectUniqueId=ROBOT_2,
            parentLinkIndex=-1,
            replaceItemUniqueId=Y_AX_2,
            physicsClientId=PYB_CLIENT,
        )
        Z_AX_2 = p.addUserDebugLine(
            lineFromXYZ=[0, 0, 0],
            lineToXYZ=[0, 0, 0.1],
            lineColorRGB=[0, 0, 1],
            parentObjectUniqueId=ROBOT_2,
            parentLinkIndex=-1,
            replaceItemUniqueId=Z_AX_2,
            physicsClientId=PYB_CLIENT,
        )
        ...
        p.applyExternalTorque(
            ROBOT_1,
            -1,
            torqueObj=[0.0, 0.0, 5e-5],  # 5e-5  # 5e-5  # 5e-5
            flags=p.LINK_FRAME,  # p.WORLD_FRAME
            physicsClientId=PYB_CLIENT,
        )
        p.applyExternalForce(
            ROBOT_1,
            -1,
            forceObj=[0.0, 0.0, 0.0],  # 5e-2,  # 5e-2,  # 5e-2
            posObj=[0.0, 0.0, 0.0],
            flags=p.LINK_FRAME,  # p.WORLD_FRAME
            physicsClientId=PYB_CLIENT,
        )
