...
from gpd.gym_pybullet_drones.envs.BetaAviary import BetaAviary
from gpd.gym_pybullet_drones.control.CTBRControl import CTBRControl
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Test flight script using SITL Betaflight"
    )
    parser.add_argument(
        "--drone",
        default=DEFAULT_DRONES,
        type=DroneModel,
        help="Drone model (default: BETA)",
        metavar="",
        choices=DroneModel,
    )
    parser.add_argument(
